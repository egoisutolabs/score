...
import { DispatchService, type DispatchServiceOptions } from "@score/core/dispatch/service";
import type { TaskBriefingWriter } from "@score/core/dispatch/task-briefing-port";
import type { WorkIdentity, WorktreeObservation } from "@score/core/dispatch/work";
import type { WorkSource } from "@score/core/dispatch/work-source";
import type { PullRequestObservation } from "@score/core/landing/change";
import type { ChangeHost } from "@score/core/landing/port";
import type { PrimaryCheckoutObservation, WorkspaceDriver } from "@score/core/workspace-driver";
