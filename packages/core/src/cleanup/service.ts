...
import { cleanupStatusIsSafe } from "@score/core/cleanup/policy";
import type { CleanupResult } from "@score/core/cleanup/result";
import { issueNumberFromBranch, sessionNameForIssue } from "@score/core/dispatch/identity";
import { isOwnedIssueWorktree } from "@score/core/dispatch/policy";
