 ...
 * score-namespace job the supervisor still knows about. Pure reads — the
 * console is a disposable viewer, so a missing or garbled file degrades the
 * dot, never crashes the poll.
 */
